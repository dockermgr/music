...
# @@Created          :  Wednesday, Sep 07, 2022 00:06 EDT
# @@File             :  install.sh
# @@Description      :
...
SERVER_PORT_EXT="${SERVER_PORT_EXT:-19020}"
SERVER_PORT_INT="${SERVER_PORT_INT:-80}"
SERVER_PORT_ADMIN_EXT="${SERVER_PORT_ADMIN_EXT:-19021}"
SERVER_PORT_ADMIN_INT="${SERVER_PORT_ADMIN_INT:-8000}"
SERVER_PORT_OTHER_EXT="${SERVER_PORT_OTHER_EXT:-6600}"
SERVER_PORT_OTHER_INT="${SERVER_PORT_OTHER_INT:-6600}"
